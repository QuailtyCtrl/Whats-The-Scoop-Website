...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Handcrafted ice cream, non-dairy scoops and frozen treats in Innisfil, Ontario. Open daily on Innisfil Beach Road." },
      { property: "og:title", content: "What's The Scoop? — Handcrafted Ice Cream in Innisfil, ON" },
      { property: "og:description", content: "Handcrafted ice cream, non-dairy scoops and frozen treats in Innisfil, Ontario. Open daily on Innisfil Beach Road." },
